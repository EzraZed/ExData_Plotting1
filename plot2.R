...
## Plot the Global_active_power versus Date_Time with appropriate titles
plot(household_data$Date_Time, household_data$Global_active_power, type = "l", xlab = NA, ylab = "Global Active Power (kilowatts)")
